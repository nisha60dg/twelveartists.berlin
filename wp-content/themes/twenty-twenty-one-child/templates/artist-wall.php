				...
				<div class="full_width">
					<div class="eight_width">
						<div class="left_content_slide artist_series_wrap"> 
							<div class="artist_series"> 
								...
								<?php 
									/* $artist_grid_cols = $response_data->data->wallSettings->cols;
									echo '<div class="SeriesArtworksList" style="grid-template-rows: repeat('. $response_data->data->wallSettings->rows .', auto);  grid-template-columns: repeat('. $artist_grid_cols .', 1fr);">'; */
								?>
								<?php 
									 $artist_grid_cols = $response_data->data->wallSettings->cols;
									echo '<div class="SeriesArtworksList" style="grid-template-rows: repeat('. $response_data->data->wallSettings->rows .', auto);  grid-template-columns: repeat('. $artist_grid_cols .', 1fr); grid-auto-flow: row;">';
								?>
								 
								<?php
									foreach($wall_data as $artwork) {
					...
					<div class="four_width"> 
						<div class="scale_0_8 right_content_slide">
							<p><strong class="dark"><a class="dark" href="/artists/">Our Artists</a></strong><br><strong><?php echo $response_data->data->wallSettings->artist_name; ?></strong></p>
						...
						<div class="site_navigation">
							...
							<div class="arrowListRow">
								<a href="/showroom/<?php echo $response_data->data->wallSettings->showroom_prefix; ?>/wall/<?php echo $prev_wall; ?>"><div class="leftArrow"><span class="dashicons dashicons-arrow-left-alt"></span></div></a>
								<div class="navMenuIcon"><span class="dashicons dashicons-menu"></span></div>
								<a href="/showroom/<?php echo $response_data->data->wallSettings->showroom_prefix; ?>/wall/<?php echo $next_wall; ?>"><div class="rightArrow"><span class="dashicons dashicons-arrow-right-alt"></span></div></a>
							</div>
						</div>
					</div>
				</div>
