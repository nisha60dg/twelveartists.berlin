<?php
/*
Template Name: Order Process Step 1
*/
?>
<!doctype html>
				...
				<div class="full_width">
					<div class="eight_width">
						<div class="left_content_slide">
							<img src="<?php bloginfo('stylesheet_directory'); ?>/images/landing-slide3.jpg" alt="MARCELO VIQUEZ">
						</div>
					</div>
					<div class="four_width">
						<div class="scale_0_8 right_content_slide">
							...
							<p><br><br>As a <a href="">Club member</a>, you can purchase this <strong>art</strong>+NFT here and now for <strong class="dark">1,850 ETH including VAT plus gas fees.</strong></p>
						</div>
